...
//
// Monthly limit (50/month) applies ONLY to /case-study (Call 1 — starts the combined
...
router.post('/case-study',              authMiddleware, featureLimitMonthly('drafting_lab', 50), startCaseStudy);

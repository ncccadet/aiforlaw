...
const STYLES = `
.iv-root{--bg:#090a0f;--surface:rgba(18, 19, 26, 0.88);--surface-2:rgba(28, 30, 42, 0.95);--border:rgba(212, 175, 55, 0.32);--text:#f8f5eb;--muted:#b8af94;--accent:#d4af37;--rec:#e57373;--ok:#81c784;
...
.iv-container{max-width:920px;margin:0 auto;padding:clamp(16px,4vw,40px);}
...
.iv-title{font-size:clamp(24px,5vw,36px);margin:0 0 6px;font-weight:700;background:linear-gradient(135deg, #FFF1C5 0%, #D4AF37 50%, #AA771C 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;filter:drop-shadow(0 2px 10px rgba(212, 175, 55, 0.3));}
.iv-subtitle{margin:0;color:var(--muted);font-size:clamp(14px,2.5vw,16px);}
.iv-badge{border:1px solid var(--border);color:var(--accent);border-radius:999px;padding:4px 14px;font-size:12px;white-space:nowrap;background:rgba(212, 175, 55, 0.1);box-shadow:0 0 10px rgba(212, 175, 55, 0.1);}
.iv-card{background:var(--surface);backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);border:1px solid var(--border);border-radius:16px;padding:clamp(18px,3.5vw,28px);margin-bottom:20px;box-shadow:0 12px 35px rgba(0,0,0,0.8), 0 0 20px rgba(212, 175, 55, 0.08);}
.iv-h2{font-size:17px;margin:0 0 12px;font-weight:700;color:#FFF1C5;}
.iv-error{color:#e6bcbc;border-color:#5a3a3a;}
.iv-chips{display:flex;gap:10px;flex-wrap:wrap;}
.iv-chip{font-family:inherit;font-size:15px;padding:10px 18px;border-radius:10px;border:1px solid var(--border);background:var(--surface-2);color:var(--text);cursor:pointer;transition:border-color .2s, transform .15s;}
.iv-chip.sel{background:linear-gradient(135deg, #FFF1C5 0%, #D4AF37 50%, #AA771C 100%);color:#07070a;border-color:#D4AF37;font-weight:700;box-shadow:0 4px 15px rgba(212, 175, 55, 0.3);}
...
.iv-btn{font-family:inherit;font-size:15px;border-radius:10px;padding:12px 22px;cursor:pointer;border:1px solid var(--border);transition:transform .15s, box-shadow .15s;}
.iv-btn:disabled{opacity:.5;cursor:not-allowed;}
.iv-primary{background:linear-gradient(135deg, #FFF1C5 0%, #D4AF37 50%, #AA771C 100%);color:#07070a;border-color:#D4AF37;font-weight:700;box-shadow:0 4px 20px rgba(212, 175, 55, 0.35);}
